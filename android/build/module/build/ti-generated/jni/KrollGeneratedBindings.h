	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.mlkit.objectdetection.TiMlkitDetectionModule", ::ti::mlkit::objectdetection::TiMlkitDetectionModule::bindProxy, ::ti::mlkit::objectdetection::TiMlkitDetectionModule::dispose}
			};
